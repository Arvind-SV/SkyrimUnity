...
public class StaticRecord : BaseRecord
{
    public string EDID;
    public string MODL;

    public StaticRecord(BaseRecord baseRecord) : base(baseRecord)
    {
    ...
    public void ReadFromFile()
    {
        ...
        while (processedBytes < numBytes)
        {
            ...
            else if(fieldType == "MODL")
            {
                MODL = StringUtil.ReadZStringFromFile(file, fieldSize);
            }
            else
            {
