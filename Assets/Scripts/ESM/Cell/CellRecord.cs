...
public class CellRecord : BaseRecord
{
    public string EDID;
    public string FULL;

    public ReferenceGroup persistentReferences;
    public ReferenceGroup temporaryReferences;

    public CellRecord(BaseRecord baseRecord) : base(baseRecord)
    {
